...
//Se redefinen los metodos sense() y act() de agente pelota una agente pelota no planifica asi que no se redefine plan()
...
function Setup(){
  ...
  mapa[6] =  "x                       x";
  mapa[7] =  "x                       x";
  mapa[8] =  "xx  xxxxxxxxxxxxxxxxxxxxx";
  mapa[9] =  "x                       x";
  mapa[10] = "x                       x";
  mapa[11] = "x                       x";
  mapa[12] = "x   r  r                x";
  ...
  mapa[17] = "x                       x";
  mapa[18] = "x                       x";
  mapa[19] = "xxxxxx   xxxxxxxxxxxxxxxx";
  mapa[20] = "x                       x";
  mapa[21] = "x         r             x";
  mapa[22] = "x                       x";
  mapa[23] = "x                       x";
