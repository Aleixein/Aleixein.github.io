...
AJEDREZ.torres = function(){
  var torreBlanca1 = new THREE.Mesh( new AJEDREZ.torreForma(), marmolBlanco);
  var torreBlanca2 = new THREE.Mesh( new AJEDREZ.torreForma(), marmolBlanco);
  var torreNegra1 = new THREE.Mesh( new AJEDREZ.torreForma(), marmolNegro);
  var torreNegra2 = new THREE.Mesh( new AJEDREZ.torreForma(), marmolNegro);
